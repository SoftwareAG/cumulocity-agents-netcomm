name "cumulocity-staging-performance-test-nonprod"
...
override_attributes(
  "domainname" => "staging-pt.c8y.io",

  "environment" => {
      "address" => "management.staging-pt.c8y.io"
  },
  "swapfilesize" => 512,
  'yum' => {
    'repositories' => {
  ...
  "cumulocity-kubernetes" => {
     "deployK8S4env" => "cumulocity-staging-performance-test-nonprod",
     "attachedEnvs" => ["cumulocity-staging-performance-test-nonprod"],
  ...
  "cumulocity-karaf" => {
    "CUMULOCITY_LICENCE_KEY" => "5a88b9e58b59256dd2843e2b5562c9b4bb98b996f93efd7d2a0c8724cd8b0be6230cf6d6fd50412a55cc647fd495d71cbd2e9a32075ae157f253c2dedbee6f5b",
    "version" => "9.10.0-1",
  ...
  "cumulocity-external-lb" => {
    "landing_page" => "https://staging-pt.c8y.io/apps/devicemanagement",
    "paas_default_page" => "https://$http_host/apps/$defapp",
    "paas_public_default_page" => "https://staging-pt.c8y.io/apps/dmpublic",
