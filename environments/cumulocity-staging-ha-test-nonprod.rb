name "cumulocity-staging-ha-test-nonprod"
description "The Staging 7 environment for the latest released version"

cookbook_versions({
'cumulocity'=>'= 0.6.0',
'cumulocity-kubernetes'=>'= 0.6.2',
'cumulocity-ssagents'=>'= 0.4.0'
})

override_attributes(
  "domainname" => "staging-ha.c8y.io",

  "environment" => {
      "address" => "management.staging-ha.c8y.io"
  },
  "swapfilesize" => 512,
  'yum' => {
    'repositories' => {
  ...
  "cumulocity-kubernetes" => {
     "deployK8S4env" => "cumulocity-staging-ha-test-nonprod",
     "attachedEnvs" => ["cumulocity-staging-ha-test-nonprod"],
     "token" => "1e3145.2ff901841d78af1d",
  ...
  "cumulocity-karaf" => {
    "CUMULOCITY_LICENCE_KEY" => "6d4e5cf9437539a8eec52e9e8d4b14dbf7418bd10b40ab360f565a6c34823a922121636fdfcb5d59d948a38bb0887f307045374a298609a710eab0d3df911bf9",
    "version" => "9.12.4-1",
  ...
  "cumulocity-external-lb" => {
    "landing_page" => "https://staging-ha.c8y.io/apps/devicemanagement",
    "paas_default_page" => "https://$http_host/apps/$defapp",
    "paas_public_default_page" => "https://staging-ha.c8y.io/apps/dmpublic",
