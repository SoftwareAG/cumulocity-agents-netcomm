name "cumulocity-staging-pe-1-nonprod"
...
override_attributes(
  "domainname" => "staging-1.c8y.io",

  "environment" => {
      "address" => "management.staging-1.c8y.io"
  },
  "swapfilesize" => 512,
  'yum' => {
    'repositories' => {
  ...
  "cumulocity-kubernetes" => {
     "deployK8S4env" => "cumulocity-staging-pe-1-nonprod",
  ...
  "cumulocity-core" => {
    "properties" => {
      ...
      "email.host" => "postfix.cumulocity-staging-pe-1-nonprod.svc.cluster.local",
      "email.from" => "no-reply@staging-1.c8y.io",
      ...
      "passwordReset.token.email.template" => 'Dear staging-1.c8y.io user,\n\n\
            You or someone else entered this email address when trying to change the password of a staging-1.c8y.io portal user.\n\n\
            Please use the following link to reset your password: \n\
            {host}?token={token}&showTenant\n\n\
            If you were not expecting this email, please ignore it. \n\n\
            Kind regards,\n\
            staging-1.c8y.io support team\n',
            ...
            If you were not expecting this email, please ignore it. In case of questions, please get in contact with the administrator of staging-1.c8y.io portal. \n\n\
            Kind regards,\n\
            staging-1.c8y.io support team\n',
            "passwordReset.success.email.template" => 'Dear staging-1.c8y.io user,\n\n\
  ...
  "cumulocity-external-lb" => {
    ...
    "paas_public_default_page" => "https://staging-1.c8y.io/apps/dmpublic",
