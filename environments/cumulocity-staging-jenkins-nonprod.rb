name "cumulocity-staging-jenkins-nonprod"
...
override_attributes(
  "domainname" => "staging-jenkins.c8y.io",

  "environment" => {
      "address" => "management.staging-jenkins.c8y.io"
  },
  "swapfilesize" => 512,
  'yum' => {
    'repositories' => {
  ...
  "cumulocity-kubernetes" => {
     "deployK8S4env" => "cumulocity-staging-jenkins-nonprod",
     "attachedEnvs" => ["cumulocity-staging-jenkins-nonprod"],
  ...
  "cumulocity-external-lb" => {
    "landing_page" => "https://staging-jenkins.c8y.io/apps/devicemanagement",
    "paas_default_page" => "https://$http_host/apps/$defapp",
    "paas_public_default_page" => "https://staging-jenkins.c8y.io/apps/dmpublic",
