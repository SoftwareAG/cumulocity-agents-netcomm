name "cumulocity-staging-autosen-nonprod"
description "This is an pre-commertial environment only for Autosen development"
...
override_attributes(
  "domainname" => "staging-autosen.c8y.io",

  "environment" => {
      "address" => "management.staging-autosen.c8y.io"
  },
  "swapfilesize" => 512,
  'yum' => {
    'repositories' => {
  ...
  "cumulocity-kubernetes" => {
     "deployK8S4env" => "cumulocity-staging-autosen-nonprod",
     "attachedEnvs" => ["cumulocity-staging-autosen-nonprod"],
     "token" => "1e3145.2ff901841c87ad1d",
     "images-connString" => "https://K8Simages:K8S^imAgEs5000%@resources.cumulocity.com/kubernetes-images",
     "images-version" => "9.16.2",
     "images2install" => [ "cep","cep-small","device-simulator","smartrule","sms-gateway","branding" ],
     "monitoring" => {
       "enabled" => true,
       "dashboard-only" => true
     }
  ...
  "cumulocity-karaf" => {
    "CUMULOCITY_LICENCE_KEY" => "300774ee2022b6cb5c05da41711a6d7f7537b66172b1e9d7d3206ba6343f6387d73243e192431cfeaddfafed4a3a03bf452e81cfb0b963b7e390a739562a6c08",
    "version" => "9.16.2-1",
