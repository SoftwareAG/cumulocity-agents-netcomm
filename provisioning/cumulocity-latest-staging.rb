...
add_machine_options(
  bootstrap_options: {
    ...
    subnet_id: 'subnet-07baeb09b02b9ab27',
    security_group_ids: ['sg-0d3076e71e2ac08aa']
  }
)
...
private_ips_for_c8ycore   = ["172.20.2.211","172.20.2.212","172.20.2.213","172.20.2.214","172.20.2.215","172.20.2.216","172.20.2.217","172.20.2.218","172.20.2.219","172.20.2.220"]

ontoplb_count = 1
flavour_for_ontoplb       = "m5.large"
volume_size_for_ontoplb   = 20
private_ips_for_ontoplb   = ["172.20.2.247","172.20.2.248","172.20.2.249"]

ssagent_count = 1
flavour_for_ssagent       = "t3.medium"
volume_size_for_ssagent   = 20
private_ips_for_ssagent   = ["172.20.2.250"]
ssagent_tags  = [
    ["ssl-management-agent-server","lwm2m-agent-server"],
]

mongodb_count = 3
flavour_for_mongodb       = "m5.xlarge"
volume_size_for_mongodb   = 200
private_ips_for_mongodb   = ["172.20.2.111","172.20.2.112","172.20.2.113"]
mongodb_cluster = [
...
flavour_for_masters       = "m5.large"
volume_size_for_masters   = 20
private_ips_for_masters   = ["172.20.2.55","172.20.2.56","172.20.2.57"]

kubernetes_worker_count   = 4
flavour_for_workers       = "m5.xlarge"
volume_size_for_workers   = 50
private_ips_for_workers   = ["172.20.2.61","172.20.2.62","172.20.2.63","172.20.2.64","172.20.2.65"]
...
#                recipe 'cumulocity-chaos-monkey::server_terminations' if i == 7
            end
        end
    end
