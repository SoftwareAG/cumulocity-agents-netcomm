...
environment  = 'cumulocity-staging-devops'
...
add_machine_options(
  bootstrap_options: {
    ...
    subnet_id: 'subnet-0d0220a5ccd5cacf9',
...
private_ips_for_ssagent   = ["172.20.5.250"]
ssagent_tags  = [
...
mongodb_cluster = [
      ...
      ["configreplset:config9:S","replicaset:rs01:S","replicaset:rs02:P","replicaset:rs03:H"],
      ["configreplset:config9:H","replicaset:rs01:H","replicaset:rs02:S","replicaset:rs03:P"],
      ["replicaset:rs04:P","replicaset:rs05:H","replicaset:rs06:S"],
      ["replicaset:rs04:S","replicaset:rs05:P","replicaset:rs06:H"],
      ["replicaset:rs04:H","replicaset:rs05:S","replicaset:rs06:P"]
]
