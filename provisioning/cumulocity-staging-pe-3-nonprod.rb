...
# with_driver 'aws:cumulocity'
with_driver 'aws:cumulocity:eu-central-1'
# with_driver 'aws:cumulocity:eu-west-1'

environment  = 'cumulocity-staging-pe-3-nonprod'
...
private_ips_for_c8ycore   = ["172.31.21.211","172.31.21.212","172.31.21.213","172.31.21.214","172.31.21.215","172.31.21.216","172.31.21.217","172.31.21.218","172.31.21.219","172.31.21.220"]

ontoplb_count = 1
flavour_for_ontoplb       = "m4.large"
volume_size_for_ontoplb   = 16
private_ips_for_ontoplb   = ["172.31.21.247","172.31.21.248","172.31.21.249"]

ssagent_count = 1
flavour_for_ssagent       = "m4.large"
volume_size_for_ssagent   = 20
private_ips_for_ssagent   = ["172.31.21.250"]
ssagent_tags  = [
...
private_ips_for_mongodb   = ["172.31.21.111","172.31.21.112","172.31.21.113"]
mongodb_cluster = [
...
private_ips_for_masters   = ["172.31.21.55","172.31.21.56","172.31.21.57"]

kubernetes_worker_count   = 3
flavour_for_workers       = "c4.xlarge"
volume_size_for_workers   = 30
private_ips_for_workers   = ["172.31.21.61","172.31.21.62","172.31.21.63","172.31.21.64","172.31.21.65"]
