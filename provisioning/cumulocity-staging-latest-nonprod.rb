...
environment  = 'cumulocity-staging-latest-nonprod'
...
private_ips_for_ssagent   = ["172.31.10.245"]
ssagent_tags  = [
        ["sms-gateway-server"]
]
...
private_ips_for_masters   = ["172.31.10.57","172.31.10.58","172.31.10.59"]
flavour_for_masters       = "m4.large"

kubernetes_worker_count   = 3
private_ips_for_workers   = ["172.31.10.61","172.31.10.62","172.31.10.63"]
